...
## Algoritmo escolhido & Justificativa da escolha
...
Arquitetura em microsserviço com FastAPI (api/main.py), conteinerizada via Docker, protegida por chave de API (x-api-key) e variáveis de ambiente (.env), integrando o Frontend/Backend (Java/.NET) diretamente ao motor de IA.
